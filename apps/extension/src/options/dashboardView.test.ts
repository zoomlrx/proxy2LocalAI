...
const config: AppConfig = {
  ...
  token: "local-token",
  profiles: [
    { id: "p1", name: "Chat", enabled: true, targetOrigin: "https://a.example", targetPath: "/chat", methods: ["POST"], projectDir: "", provider: "claude", responseMode: "stream", allowDangerousCli: false, enableConversationMemory: false, timeoutMs: 0, maxBodyBytes: 0, contextRegexFlags: "s", sseDataEvents: ["message"], setupMode: "wizard", responseTemplateId: "openai_sse", sensitiveHeaderPolicy: "default", debugEnabled: true },
    { id: "p2", name: "Code", enabled: false, targetOrigin: "https://b.example", targetPath: "/code", methods: ["POST"], projectDir: "", provider: "codex", responseMode: "block", allowDangerousCli: false, enableConversationMemory: false, timeoutMs: 0, maxBodyBytes: 0, contextRegexFlags: "s", sseDataEvents: ["message"], setupMode: "advanced", responseTemplateId: "openai_chat_json", sensitiveHeaderPolicy: "default", debugEnabled: true },
    { id: "p3", name: "Map", enabled: true, targetOrigin: "https://c.example", targetPath: "/map", methods: ["POST"], projectDir: "", provider: "claude", responseMode: "mapped_sse", allowDangerousCli: false, enableConversationMemory: false, timeoutMs: 0, maxBodyBytes: 0, contextRegexFlags: "s", sseDataEvents: ["message"], setupMode: "advanced", responseTemplateId: "generic_sse", sensitiveHeaderPolicy: "default", debugEnabled: true }
  ]
};
